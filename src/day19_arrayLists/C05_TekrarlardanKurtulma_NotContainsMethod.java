...
public class C05_TekrarlardanKurtulma_NotContainsMethod {
    public static void main(String[] args) {
        ...
        List<Integer> benzersizElementlerList = new ArrayList<>();//empty List
        ...
        arr= new int[benzersizElementlerList.size()]; // [0, 0, 0, 0, 0, 0] //an empty array but we must define its length
        for (int i = 0; i < arr.length ; i++) {
